...
mod inner {
    ...
    use crate::clientbound::specs::play::PositionAndLookSpec;

    #[derive(PacketEncode)]
    #[falcon_packet(107, 108, 109, 110, 210, 315, 316, 335 = 0x2E; 338, 340 = 0x2F; 393, 401, 404 = 0x32; no_receive; outgoing = "position_look")]
    ...
    #[derive(PacketEncode)]
    #[falcon_packet(107, 108, 109, 110, 210, 315, 316, 335, 338, 340 = 0x1D; 393, 401, 404 = 0x1F; no_receive; outgoing = "unload_chunk")]
